...
import appointmentsReducer from './store/appointmentReducer';

import '../node_modules/bootstrap/dist/css/bootstrap.min.css';
import 'bootstrap';


const reducer = combineReducers({ auth: authReducer, appointments: appointmentsReducer }); // Using combine Reducers here although only one reducer is present
